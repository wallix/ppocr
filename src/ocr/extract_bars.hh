#ifndef EXTRACT_BARS_HH
#define EXTRACT_BARS_HH
...
namespace ocr
{
    ...
    static const titlebar_color titlebar_colors[] = {
        ...
        {rgb8(10,  36,  106), rgb8(255,255,255), 0},
        ...
        {rgb8(156, 182, 214), rgb8(0,0,0)      , 2}, // russian
    };
    ...
    static const rgb8 titlebar_win2012[] = {
        rgb8(99, 203, 239),
        rgb8(90, 186, 214),
        rgb8(82, 166, 198),
        rgb8(74, 146, 173),
    ...
    struct titlebar_color_windows2012_standard {
        ...
        {
            return
                titlebar_win2012[0] == c
             || titlebar_win2012[1] == c
             || titlebar_win2012[2] == c
             || titlebar_win2012[3] == c
            ;
        }
        ...
        {
            return
                titlebar_win2012[4] == c
             || titlebar_win2012[5] == c
             || titlebar_win2012[6] == c
            ;
        }
        ...
        if (tid == titlebar_color_id::WINDOWS_2012) {
            ...
            for (; y < max_row; ++y) {
                if (!(tcolor.threshold_bars(input(y, button_col))
                 && rgb8(49, 48, 49) == input(y, button_col+1)
            ...
            if (tcolor.threshold_bars(input(y, button_col))
             && rgb8(49, 48, 49) == input(y, button_col+1)
             && rgb8(49, 48, 49) == input(y, button_col+2)) {
                return true;
            }
            return false;
        }
