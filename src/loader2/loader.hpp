...
#ifndef PPOCR_SRC_LOADER2_LOADER_HPP
#define PPOCR_SRC_LOADER2_LOADER_HPP
...
enum class PolicyLoader { img, img90, img_img90};
...
struct Loader
{
    ...
    private:
        struct impl : strategy_type, relationship_type /*empty class optimization*/ {
            ...
            void load_impl(Image const & img, Image const &, policy<PolicyLoader::img>) {
                this->values.push_back(this->load(img, img));
            }

            void load_impl(Image const &, Image const & img90, policy<PolicyLoader::img90>) {
                this->values.push_back(this->load(img90, img90));
            }

            void load_impl(Image const & img, Image const & img90, policy<PolicyLoader::img_img90>) {
