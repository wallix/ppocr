...
int main(int ac, char **av)
{
    ...
    struct { bool enable; unsigned interval; } const intervals[] = {
        {10, strategies::hdirection::traits::get_interval()},
        {10, strategies::hdirection90::traits::get_interval()},
        {10, strategies::hdirection2::traits::get_interval()},
        {10, strategies::hdirection290::traits::get_interval()},
        {10, strategies::hgravity::traits::get_interval()},
        {10, strategies::hgravity90::traits::get_interval()},
        {10, strategies::hgravity2::traits::get_interval()},
        {10, strategies::hgravity290::traits::get_interval()},
        {10, strategies::proportionality::traits::get_interval()},
        {10, strategies::dvdirection::traits::get_interval()},
        {10, strategies::dvdirection90::traits::get_interval()},
        {10, strategies::dvdirection2::traits::get_interval()},
        {10, strategies::dvdirection290::traits::get_interval()},
        {10, strategies::dvgravity::traits::get_interval()},
        {10, strategies::dvgravity90::traits::get_interval()},
        {10, strategies::dvgravity2::traits::get_interval()},
        {10, strategies::dvgravity290::traits::get_interval()},
        {10, strategies::density::traits::get_interval()},
    };
